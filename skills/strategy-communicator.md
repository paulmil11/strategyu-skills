...
**Opening paragraph = the main idea.** Not context. Not background. The recommendation.

**Supporting sections = insights.** One per section. Section header is the insight statement.

**Evidence within sections.** Only what's needed to support the insight. Not everything you found.

**Closing = action.** What specifically needs to happen next. Who does what by when.

### For Emails

**Subject line = the main idea.** "Recommend shifting $500K from Channel A to B" not "Marketing budget discussion."

**First sentence = the ask.** What you need from the reader.

**Body = supporting insights.** Numbered, brief.

**Close = deadline and next step.**
